...
<Callout type="info" title="Standard Format">
  In New API, Jina AI's rerank format is adopted as the standard format. Rerank
  responses from all other providers (e.g., Xinference, Cohere, etc.) will be
  formatted into Jina AI's format to provide a unified development experience.
</Callout>
