---
title: Kling AI (クリング) および Jimeng (ジーメン) フォーマット
---

動画生成APIを呼び出して動画を生成します。以下の複数の動画生成サービスをサポートしています：

- **Kling AI (クリング)**: [APIドキュメント](https://app.klingai.com/cn/dev/document-api/apiReference/commonInfo)
- **Jimeng (ジーメン)**: [APIドキュメント](https://www.volcengine.com/docs/85621/1538636)
